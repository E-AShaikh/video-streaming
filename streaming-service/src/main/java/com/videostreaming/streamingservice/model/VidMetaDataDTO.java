...
public class VidMetaDataDTO {
    ...
    public VidMetaDataDTO() {
    }

    public VidMetaDataDTO(int id) {
        this.id = id;
    }

    public VidMetaDataDTO(String vidName, String vidDescription) {
    ...
    public boolean equals(Object o) {
        ...
        VidMetaDataDTO that = (VidMetaDataDTO) o;
        return id == that.id;
    }
